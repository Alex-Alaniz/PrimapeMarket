...
export function Footer() {
  ...
  return (
    <footer className={`border-t py-2 ${theme === "light" ? "bg-primary" : theme === "dark" ? "bg-primary" : "bg-transparent"}`}>
      <div className="container mx-auto">
        ...
        <div className="mt-1 border-t border-muted/20 pt-1">
          <p className="text-xs text-center">
            ...
            <span className="text-xs text-muted-foreground">Prime ape predictions on ApeChain.</span>
            <span className="mx-1 text-muted-foreground">•</span>
            <span className="text-muted-foreground">BearifiedCo | ApeForge © 2025</span>
          </p>
        </div>
      </div>
    </footer>
