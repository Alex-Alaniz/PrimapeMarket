...
echo "Inserting user stats and predictions..."
psql -d primape_market_db -c "
DO \$\$
DECLARE
  user_record RECORD;
...
psql -d primape_market_db -c "\dt"

# Show sample data
echo "Sample users:"
psql -d primape_market_db -c "SELECT * FROM users LIMIT 3;"

echo "Sample user stats:"
psql -d primape_market_db -c "SELECT * FROM user_stats LIMIT 3;"

echo "Sample predictions:"
psql -d primape_market_db -c "SELECT * FROM predictions LIMIT 3;"

echo "Sample markets:"
psql -d primape_market_db -c "SELECT * FROM markets LIMIT 3;"
